...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { email: @submission.email, questionnaire_id: @submission.questionnaire_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { email: @submission.email, questionnaire_id: @submission.questionnaire_id } }
